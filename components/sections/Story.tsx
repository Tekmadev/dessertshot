        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20 items-end">
          <div className="md:col-span-7">
            ...
            <motion.h2
              ...
              style={{ fontSize: "clamp(38px, 11vw, 132px)" }}
            >
              Four{" "}
              <em
                className="italic"
          ...
          <motion.div
            ...
            className="md:col-span-5 max-w-[44ch] text-[18px] md:text-[20px] leading-[1.55] tracking-[-0.005em] text-ink/80 md:text-ink/75"
          >
            {copy.feature.body}
          </motion.div>
        </div>
